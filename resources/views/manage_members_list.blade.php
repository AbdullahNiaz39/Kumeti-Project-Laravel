                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2 padd_right">
                                    <div class="input_label_box">
                                        ...
                                        <input type="text" placeholder="" name="member_code" value="{{ $member_code }}" >
                                        @error('member_code')
...
<script>
    ...
    function add_more() {
        loop_count++;
        var html ='<input type="hidden" id="mmd" name="mmd[]"><div id="member_attr_'+loop_count+'"><div class="form-group"><div class="row"><div class="col-sm-2 padd_right"><div class="input_label_box"><label>Name*</label><input type="text" placeholder="" id="gname"  name="gname[]"></div></div><div class="col-sm-2 padd_right"><div class="input_label_box"><label>Phone</label><input type="text" name="gphone[]" id="gphone" placeholder=""></div></div><div class="col-sm-2 padd_right"><div class="input_label_box"><label>CNIC</label><input type="text" name="gcnic[]" id="gcnic"></div></div><div class="col-sm-5"><div class="input_label_box"><label>Address</label><input type="text" id="gcnic" name="gaddress[]"></div></div><div class="col-sm-1"><div class="minus_btn"><a onclick=remove_more("'+loop_count+'") id="Remove"><i class="fa fa-minus"></i></a></div></div></div></div></div>';
             jQuery('#member_gruantee').append(html);
    }
