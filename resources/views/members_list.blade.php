            ...
            <div class="col-sm-9">
                <div class="page-header-breadcrumb">
                    <ul class=" breadcrumb breadcrumb-title">
                        ...
                        <li class="breadcrumb-item"><a href="#">Members List</a> </li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="add_new">
                    <a href="{{ url('manage_members_list') }}" class="btn-inner-menu">
                        ...
                        <table id="myTable" class="table_box">
                            ...
                            <tr>
                               ...
                               <td>{{$list->name}}</td>
                                ...
                                <td>
                                    <a class="create_btn" href="{{url('manage_members_list')}}/{{$list->id}}" title="Edit"><i
                                            class="feather icon-edit"></i></a>

                                    <a href="{{url('delete_members_list')}}/{{$list->id}}" title="Trash"><i class="feather icon-trash"></i></a>
                                </td>
