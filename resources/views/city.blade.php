...
@endif
           <div class="row align-items-end">
              ...
              <div class="col-lg-3">
                <div class="add_new">
                 <a href="{{url('manage_city')}}" class="btn-inner-menu">
             ...
             <div class="row">
                ...
                <div class="col-lg-12 right_contents">
                  ...
                  @foreach ($data as $list)
                           ...
                           <td>{{$list->name}}</td>
                           <td>
                               <a class="create_btn" href="{{url('manage_city')}}/{{$list->id}}" title="Edit"><i class="feather icon-edit"></i></a>
                               <a href="{{url('delete_city')}}/{{$list->id}}" title="Trash"><i class="feather icon-trash"></i></a>
                           </td>
                         </tr>
                         @endforeach
